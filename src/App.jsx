...
export default function App() {
  ...
  return (
    <div className="tg-root">
      ...
      <main className="tg-main">
        {tab === "today" ? <TodayView progress={progress} deck={deck} mistakes={mistakes} onboarding={onboarding} onStartLesson={startLesson} onGoReview={() => setTab("review")} onGoPractice={goPractice} onStartSession={() => setSessionOpen(true)} /> : null}
