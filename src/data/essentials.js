export const ESSENTIAL_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { pt: "Mais devagar, por favor.", en: "More slowly, please.", example: "Pode falar mais devagar, por favor?" },
      { pt: "Não entendi.", en: "I didn't understand.", example: "Desculpa, não entendi." },
      { pt: "Como se diz isso em português?", en: "How do you say this in Portuguese?", example: "Como se diz ‘receipt’ em português?" },
    ],
  },
  {
    title: "Food and drink",
    items: [
      { pt: "Eu quero um café, por favor.", en: "I want a coffee, please.", example: "Eu quero um café sem açúcar." },
      { pt: "A conta, por favor.", en: "The bill, please.", example: "Pode trazer a conta, por favor?" },
      { pt: "Sem açúcar.", en: "Without sugar.", example: "Sem açúcar, por favor." },
      { pt: "Para viagem.", en: "To go.", example: "Um pão de queijo para viagem." },
    ],
  },
  {
    title: "Numbers & time",
